...
#define CHIP_DEVICE_CONFIG_ENABLE_BT_NIMBLE CONFIG_BT_NIMBLE_ENABLED | CONFIG_NIMBLE_ENABLED
#define CHIP_DEVICE_CONFIG_ENABLE_BT_BLUEDROID CONFIG_BT_BLUEDROID_ENABLED
